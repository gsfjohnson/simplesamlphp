...
cp -a * %{buildroot}%{_prefix}simplesamlphp
cp -a config-templates/* %{buildroot}%{_prefix}simplesamlphp/config/
cp -a metadata-templates/* %{buildroot}%{_prefix}simplesamlphp/metadata/
